package com.example.reactbackend.controller.lower;
...
class PersonControllerTestUpper {
    ...
    @Test
    @DirtiesContext
    void givenDBInitilizedWith3Records_whenGETPeopleWithExistingID_shouldReturn200AndPersonInLowerCase() throws Exception {
