...
public class PersonController_upper_Test {
    ...
    @Test
    @DirtiesContext
    void givenDBInitilizedWith3Records_whenGETPeopleWithExistingID_shouldReturn200AndPersonUpperCase() throws Exception {
